...
const App = {
    ...
    init() {
        ...
        this.setupParallax();
        this.loadTheme();
        console.log("SYSTEM_INITIALIZED: Python LeetCode 300 Tutorial");
    },
    ...
    applyTheme() {
        ...
        localStorage.setItem('plt-theme', this.state.theme);
    },

    loadTheme() {
        const saved = localStorage.getItem('plt-theme');
        if (saved) {
